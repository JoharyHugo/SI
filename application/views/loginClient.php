...
<body>
    <div class="container login-div row">
        <div class="col-md-7 form-div row">
            <h1 class="mb-4"> Bienvenue dans <strong>Gestion comptable</strong>, un systeme qui a pour but de  réaliser et/ou superviser toutes les opérations de comptabilité générale de l’entreprise. </p>
